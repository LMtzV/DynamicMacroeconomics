...
%%% Incisco (iv): Agentes muy aversos al reisgo i.e. sigma = 3.7
...
sigma = 3.7; % coeficiente de aversión al riesgo
p = 200; % número de puntos de la malla
rho = 0.95; % persistencia del choque estocástico
sigma_e = 0.094; % desviación estándar de las innovaciones
